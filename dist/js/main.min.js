...
$(document).ready(function(){var e=$(".sale");$("#close").on("click",function(){e.removeClass("sale_active")})});
...
$(document).ready(function(){$(".hero-slider").slick({slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:3e3,infinite:!0,speed:2e3,arrows:!0,dots:!0,prevArrow:$(".hero-arrows__left"),nextArrow:$(".hero-arrows__right"),responsive:[{breakpoint:890,settings:{arrows:!1}},{breakpoint:414,settings:"unslick"}]}),$(".hero-slider_mobile").slick({slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:3e3,infinite:!0,speed:2e3,arrows:!1,dots:!0}),$(".edge-slider").slick({slidesToShow:3,slidesToScroll:1,speed:2e3,prevArrow:$(".edge-arrows__left"),nextArrow:$(".edge-arrows__right"),responsive:[{breakpoint:850,settings:{slidesToShow:1}}]}),$(".brand-slider").slick({slidesToShow:6,slidesToScroll:1,speed:2e3,prevArrow:$(".brand-arrows__left"),nextArrow:$(".brand-arrows__right"),dotsClass:"brand-dots",responsive:[{breakpoint:1200,settings:{slidesToShow:5}},{breakpoint:1e3,settings:{arrows:!1,dots:!0,slidesToShow:3}},{breakpoint:600,settings:{centerMode:!0,centerPadding:"70px",arrows:!1,dots:!0,slidesToShow:1}}]}),$(".best-slider").slick({slidesToShow:4,slidesToScroll:1,speed:2e3,autoplay:!0,autoplaySpeed:3e3,infinite:!0,speed:2e3,dots:!0,prevArrow:$(".best-arrows__left"),nextArrow:$(".best-arrows__right"),responsive:[{breakpoint:1350,settings:{slidesToShow:3}},{breakpoint:880,settings:{slidesToShow:2,arrows:!1}},{breakpoint:500,settings:{slidesToShow:1,dots:!1}}]}),$(".follow-slider").slick({slidesToShow:8,slidesToScroll:1,speed:2e3,autoplay:!0,autoplaySpeed:3e3,infinite:!0,speed:2e3,prevArrow:$(".follow-arrows__left"),nextArrow:$(".follow-arrows__right"),responsive:[{breakpoint:1800,settings:{centerMode:!0,slidesToShow:7}},{breakpoint:1500,settings:{centerMode:!0,slidesToShow:5}},{breakpoint:1100,settings:{centerMode:!0,slidesToShow:3}},{breakpoint:500,settings:{centerMode:!0,slidesToShow:1}}]})});